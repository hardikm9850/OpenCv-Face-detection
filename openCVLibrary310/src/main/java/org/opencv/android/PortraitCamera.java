...
public class PortraitCamera extends CameraBridgeViewBase implements PreviewCallback {
    ...
    public PortraitCamera(Context context, int cameraId) {
        super(context, cameraId);
    }

    public PortraitCamera(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    private class CameraWorker implements Runnable {
        ...
        public void run() {
            do {
                synchronized (PortraitCamera.this) {
                    try {
                        PortraitCamera.this.wait();
                    } catch (InterruptedException e) {
